...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-rippl-black">
      ...
      <header className="border-b border-rippl-black-3 bg-rippl-black/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 md:py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2 md:space-x-3">
            <div className="w-9 h-9 md:w-10 md:h-10 bg-rippl-violet rounded-xl flex items-center justify-center shadow-lg shadow-rippl-violet/30 font-extrabold text-white">
              <Zap className="w-5 h-5 md:w-6 md:h-6 text-white" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-lg md:text-xl font-extrabold text-white tracking-tight">Rippl<span className="text-rippl-violet">.</span></h1>
                <span className="inline-flex items-center rounded-full border border-rippl-violet/30 bg-rippl-violet/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-rippl-violet-soft">
                  Beta
                </span>
              </div>
              <p className="text-[10px] md:text-xs text-rippl-gray hidden sm:block">Creator Platform</p>
            </div>
          </div>
      ...
      {/* 
      <section className="container mx-auto px-4 py-16 md:py-24 relative z-10 border-t border-rippl-black-3">
        <div className="text-center mb-16">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white mb-4 tracking-tight">How It Works</h2>
          <p className="text-rippl-gray max-w-xl mx-auto text-sm md:text-base">Start earning in just 3 simple steps</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 max-w-5xl mx-auto">
          <div className="text-center p-6 rounded-3xl bg-rippl-black-2 border border-rippl-black-3 hover:border-rippl-violet-dim transition-colors group">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-rippl-violet rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-xl shadow-rippl-violet/20 group-hover:scale-110 transition-transform">
              <Users className="w-8 h-8 md:w-10 md:h-10 text-white" />
            </div>
            <div className="w-8 h-8 bg-rippl-black-3 rounded-full flex items-center justify-center mx-auto mb-4 text-sm font-extrabold text-rippl-violet-soft">1</div>
            <h3 className="text-lg md:text-xl font-bold text-white mb-2">Join Campaigns</h3>
            <p className="text-rippl-gray text-sm leading-relaxed">Browse active campaigns from top brands and join ones that match your style.</p>
          </div>
          <div className="text-center p-6 rounded-3xl bg-rippl-black-2 border border-rippl-black-3 hover:border-rippl-violet-dim transition-colors group">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-emerald-500 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-xl shadow-emerald-500/20 group-hover:scale-110 transition-transform">
              <Play className="w-8 h-8 md:w-10 md:h-10 text-white" />
            </div>
            <div className="w-8 h-8 bg-rippl-black-3 rounded-full flex items-center justify-center mx-auto mb-4 text-sm font-extrabold text-emerald-400">2</div>
            <h3 className="text-lg md:text-xl font-bold text-white mb-2">Create & Submit</h3>
            <p className="text-rippl-gray text-sm leading-relaxed">Create engaging Reels, submit your content, and share it with your audience.</p>
          </div>
          <div className="text-center p-6 rounded-3xl bg-rippl-black-2 border border-rippl-black-3 hover:border-rippl-violet-dim transition-colors group">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-purple-500 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-xl shadow-purple-500/20 group-hover:scale-110 transition-transform">
              <Wallet className="w-8 h-8 md:w-10 md:h-10 text-white" />
            </div>
            <div className="w-8 h-8 bg-rippl-black-3 rounded-full flex items-center justify-center mx-auto mb-4 text-sm font-extrabold text-purple-400">3</div>
            <h3 className="text-lg md:text-xl font-bold text-white mb-2">Get Paid</h3>
            <p className="text-rippl-gray text-sm leading-relaxed">Earn money for every view your content generates. Withdraw anytime.</p>
          </div>
        </div>
      </section>
      */}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-rippl-violet rounded-xl flex items-center justify-center font-extrabold text-white shadow-lg shadow-rippl-violet/20">
                <Zap className="w-5 h-5 text-white" />
              </div>
              <span className="text-2xl font-extrabold text-white tracking-tight">Rippl<span className="text-rippl-violet">.</span></span>
            </div>
