      ...
      <Card className="w-full max-w-md bg-rippl-black-2/80 backdrop-blur-xl border border-rippl-black-3 rounded-[32px] shadow-2xl relative z-10 overflow-hidden">
        ...
        <CardContent className="px-8 pb-8">
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            {error && (
              <div className="text-sm font-bold text-red-400 bg-red-500/10 border border-red-500/20 p-4 rounded-xl">
                {error}
              </div>
            )}
          ...
          <div className="mt-6 text-center text-sm font-medium text-rippl-gray">
            ...
            <Link href="/sign-up" className="text-white hover:text-rippl-violet font-bold hover:underline transition-colors">
              Sign up today
            </Link>
          </div>
        </CardContent>
